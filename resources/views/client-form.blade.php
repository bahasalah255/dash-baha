<x-app-layout>
    <div class="p-6 lg:p-8 max-w-2xl mx-auto space-y-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Add New Client</h1>
                <p class="text-sm text-slate-500">Create a new client profile record in BahaDash.</p>
            </div>
        </div>
            ...
            <form method='post' action='{{ route('client.store') }}' class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name='phone' value="{{ old('phone') }}" placeholder="e.g. +1 234 567 890"
                               class="w-full px-4 py-3 rounded-xl border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition duration-150">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name='company' value="{{ old('company') }}" placeholder="e.g. Acme Corporation"
                           class="w-full px-4 py-3 rounded-xl border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition duration-150">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name='notes' rows="4" placeholder="Additional details or context about the client..."
                              class="w-full px-4 py-3 rounded-xl border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition duration-150">{{ old('notes') }}</textarea>
                </div>
